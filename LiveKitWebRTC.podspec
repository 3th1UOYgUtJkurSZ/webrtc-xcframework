Pod::Spec.new do |spec|
  ...
  spec.homepage = "https://github.com/chative/webrtc-xcframework"
  ...
  spec.source = {
    :http => "https://github.com/chative/webrtc-xcframework/releases/download/137.7151.07/LiveKitWebRTC.xcframework.zip"
  }
